...
public class SimpleITKBinomialBlur extends AbstractSimpleITKCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public String getParameterHelpText() {
        return "Image input, ByRef Image destination, Number repetitions";
    }
    ...
    public String getDescription() {
        return "Apply SimpleITKs Binomial Blur filter to an image.\n\n" +
